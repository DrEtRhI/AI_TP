...
function init() {
    ...
    function nombreInconnu(choix) {
        ...
        if (compteur < 9) {
            ...
            document.getElementById("texte").innerHTML = "C'est perdu vous avez épuisé vos " + (compteur) + ". Le nombre inconnu était : " + nombre + ".";
            document.getElementById("texte").style.color = "green";
            document.getElementById("texte").style.fontWeight = "900";
        }
        compteur++;
        ...
        document.getElementById("abandonBut").onclick = function () {
            ...
            document.getElementById("texte").innerHTML = "Dommage que vous abandonniez, le nombre inconnu était : " + nombre + ".";
            document.getElementById("texte").style.fontWeight = "900";
            document.getElementById("texte").style.color = "red";
